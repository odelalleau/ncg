...
def test(data_spec='f3(1000)', model_spec='1000-1', n_offline_train=10000, n_test=1000):
    ...
    experiments = {
            ...
            'batch_1000_normalize': dict(minibatch_size=None,
                                         ...
                                         normalize=True),
            'batch_1010_normalize': dict(minibatch_size=None,
                                         minibatch_offset=None,
                                         maxiter=max_samples / 1010,
                                         n_offline_train=1010,
                                         normalize=True),
            'batch_2000_normalize': dict(minibatch_size=None,
                                         minibatch_offset=None,
                                         maxiter=max_samples / 2000,
                                         n_offline_train=2000,
                                         normalize=True),
            ...
            'batch_restart': dict(minibatch_size=None,
                                  ...
                                  maxiter=max_samples / n_offline_train,
                                  restart_every=1),
            'online_1000_1_normalize': dict(minibatch_size=1000,
                                            minibatch_offset=1,
                                            maxiter=max_samples / 1000,
                                            normalize=True),
            'online_1000_10_normalize': dict(minibatch_size=1000,
                                             minibatch_offset=10,
                                             maxiter=max_samples / 1000,
                                             normalize=True),
            ...
            'online_1000_1000': dict(minibatch_size=1000,
                                     ...
                                     maxiter=max_samples / 1000),
            'online_1000_1000_normalize': dict(minibatch_size=1000,
                                               minibatch_offset=1000,
                                               maxiter=max_samples / 1000,
                                               normalize=True),
            'online_1000_1000_normalize_restart': dict(minibatch_size=1000,
                                                       minibatch_offset=1000,
                                                       maxiter=max_samples / 1000,
                                                       normalize=True,
                                                       restart_every=1),
            ...
            'online_10000_10': dict(minibatch_size=10000,
                                    minibatch_offset=10,
                                    maxiter=max_samples / 10000),
            'online_10000_10_normalize': dict(minibatch_size=10000,
                                              minibatch_offset=10,
                                              maxiter=max_samples / 10000,
                                              normalize=True),
            'online_10000_100': dict(minibatch_size=10000,
                                     minibatch_offset=100,
                                     maxiter=max_samples / 10000),
            'online_10000_100_normalize': dict(minibatch_size=10000,
                                               minibatch_offset=100,
                                               maxiter=max_samples / 10000,
                                               normalize=True),
            'online_10000_100_normalize_restart': dict(minibatch_size=10000,
                                                       minibatch_offset=100,
                                                       maxiter=max_samples / 10000,
                                                       normalize=True,
                                                       restart_every=1),
            ...
            'online_10000_10000_normalize': dict(minibatch_size=10000,
                                                 ...
                                                 maxiter=max_samples / 10000,
                                                 normalize=True),
            'online_10000_10000_normalize_restart': dict(minibatch_size=10000,
                                                         minibatch_offset=10000,
                                                         maxiter=max_samples / 10000,
                                                         normalize=True,
                                                         restart_every=1),
